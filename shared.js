function getEmotionalStatus() {
  ...
  if (hour >= 20 || hour < 5) return "🌙 He's working right now... but you're still on his mind.";
  if (hour >= 5 && hour < 12) return "😴 He just finished work. Probably sleeping now.";
  if (hour >= 12 && hour < 18) return "🟢 He's awake. You can open anything here.";
  return "🌤️ Evening is coming... he might start work soon.";
}

function getInboxStatus() { return getEmotionalStatus(); }
